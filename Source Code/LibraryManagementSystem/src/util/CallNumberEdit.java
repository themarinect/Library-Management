...
String cn;
public int spritCallNumber(String j) throws SQLException, IOException, ClassNotFoundException
{
    String s = dbt.getCallNumberEdit(j);
    String[] s1 = s.split("-");
    ...
    return c;
        ...
        public String getCallNumber(String s1,String s2,String s4) throws SQLException, IOException, ClassNotFoundException
        {
...
//        for(int i=0;i<100;i++)
//        {
            String sb = nf.format(spritCallNumber(s4));

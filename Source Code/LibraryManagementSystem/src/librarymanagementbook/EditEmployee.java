...
public class EditEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lb_username1.setText("Employee Name");

        lb_fullname.setText("Address");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txt_depart, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                            .addComponent(txt_phone1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                            .addComponent(txt_email1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                            .addComponent(txt_Adress, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                            .addComponent(txt_username1, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                            .addComponent(txt_ID, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE))
                        .addGap(139, 139, 139))))
        );
...
private void bt_applyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_applyActionPerformed
    ...
    String Addre = txt_Adress.getText();
    String Email = txt_email1.getText();
    String depa = txt_depart.getText();
    ...
    if (depa.equals("")) {
        JOptionPane.showMessageDialog(null, " Department not empty!");
        return;
    }
    if (Email.equals("")) {
    ...
    String sqlEmployeeUpdate = "update Employee set E_Name = '" + name + "',Email = '" + Email + "',BirthDay = '" + birthdate + "',Gender = '" + gender + "' ,PhoneNumber = '" + phone + "' ,Address = '" + Addre + "' ,Department = '" + depa + "' where EmployeeID = '" + EmployeID + "'";
    d.execute(sqlEmployeeUpdate);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new  
              ...
              Runnable() {
                 ...
                 public void run() {
                new EditEmployee(um).setVisible(true);
            }
        });
    }
